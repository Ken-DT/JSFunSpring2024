...
console.log(lowerCaseString("HELLO WORLD")); // Outputs: hello world
console.log(lowerCaseString()); // Outputs: undefined
console.log(lowerCaseString(null)); // Outputs: undefined
